...
file_link <- '/Volumes/GoogleDrive/My Drive/BEAM-CORE/BEAM Validation/sample output/AUS2017/'
...
for (hour in 1:24){
  print(hour)
  pic_file = paste0(file_link, 'plot/aus_speed_', hour, '.png')
...
for (hour in 1:24){
  ...
  pic_file = paste0(file_link, 'plot/aus_volume_', hour, '.png')
  png(pic_file, width = 500, height = 400)
