...
nrows=700000
loc_scenario = "/Users/cpoliziani/Downloads/Data/PILATES/"
events_fp = loc_scenario+'Baseline.csv.gz'
trips_fp = loc_scenario+'Baseline_final_trips.csv'
tours_fp = loc_scenario+'Baseline_final_tours.csv'
households_fp = loc_scenario+'Baseline_final_households.csv'
plans_fp = loc_scenario+'Baseline_final_plans.csv'
persons_fp = loc_scenario+'Baseline_final_persons.csv'
res_path = '/Users/cpoliziani/Downloads/BEAM-CORE/Results/testPT_2018_base.csv'
...
eventsSF = pd.read_csv(events_fp, compression = 'gzip', dtype = dtypes, nrows = nrows)

read_event = time.time()
print('*_*_*_*__Read the event',read_event-start, 's')
...
# ~ BGs = gpd.read_file('/Users/cpoliziani/Downloads/BEAM-CORE/PILATES/repo/beam-core-analysis/Users/Nazanin/Scenario_2010_shp/641aa0d4-ce5b-4a81-9c30-8790c4ab8cfb202047-1-wkkklf.j5ouj.shp')
...
prepivot = time.time()
print('*_*_*_*__To pivot',prepivot-read_event, 's')
#Summarised table
...
postpivot = time.time()
print('*_*_*_*__Pivot time',postpivot-prepivot, 's')
...
households = pd.read_csv(households_fp)
persons = pd.read_csv(persons_fp)
tours = pd.read_csv(tours_fp)
plans = pd.read_csv(plans_fp)
...
eventsASim.to_csv(res_path, index = False)
