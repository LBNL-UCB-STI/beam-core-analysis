...
```{r}
df_temp <- df_temp |>
  mutate(not_full_set = is.na(mode_planned_at_baseline))
sum(is.na(df_temp$mode_planned_at_baseline))
...
usual <- df_temp |> 
  ...
  summarise(nobs = n(),
            ...
            .groups = "drop")
usual |> 
  group_by(nobs, sumleverprice, sumleversize) |> 
  summarise(mostly = n(),
            .groups = "drop")
