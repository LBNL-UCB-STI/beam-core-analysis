...
# file_to_use <- "df_stacked_from_list3.rds" # this is transit
file_to_use <- "df_stacked_from_list_rh_flsz_small2.rds"
```
...
```{r echo=FALSE}
listY <- list("Potential_INEXUS_in_dollar"
              # ,
  ...
  map(as.list(levels(
    ...
    # print(plotttttIndiv)
      if(saveGraphsTF == TRUE) {
           ggsave(str_glue("figures/{Sys.Date()}_{category_short}_{lever_short}_Y-{yvarShortName}_H-{hetShortName}_Ind.png"))
           ggsave(str_glue("figures/{Sys.Date()}_{category_short}_{lever_short}_Y-{yvarShortName}_H-{hetShortName}_Ind.pdf"))
      }
...
print("Now  plot  heterogeneity,  separate graphs into different levers")
  ...
  print(plottttta1)
    if(saveGraphsTF == TRUE) {
         ggsave(str_glue("figures/{Sys.Date()}_{category_short}_{lever_short}_Y-{yvarShortName}_H-{hetShortName}_Faceted-levers.png"))
         ggsave(str_glue("figures/{Sys.Date()}_{category_short}_{lever_short}_Y-{yvarShortName}_H-{hetShortName}_Faceted-levers.pdf"))
          }
...
print("Now  plot  levers,  separate graphs into different heterogeneous groups")
  ...
  # print and save  
         print(plotttttb1)
         if(saveGraphsTF == TRUE) {
            ggsave(str_glue("figures/{Sys.Date()}_{category_short}_{lever_short}_Y-{yvarShortName}_HF{hetShortName}.png"))
            ggsave(str_glue("figures/{Sys.Date()}_{category_short}_{lever_short}_Y-{yvarShortName}_HF{hetShortName}.pdf"))
         }
...
hetShortName <- "incomeCar"
  ...
  ggplot(data = df_stacked_from_list      |> 
    ...
    # geom_ridgeline()
if(saveGraphsTF == TRUE) {
  ggsave(str_glue("figures/{Sys.Date()}_{category_short}_{lever_short}_ridge{hetShortName}.png"))
  ggsave(str_glue("figures/{Sys.Date()}_{category_short}_{lever_short}_ridge{hetShortName}.pdf"))
 }
  print(ridge0000)
```
